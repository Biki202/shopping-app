...
const Myhome = () =>{
    ...
    return(
        ...
        <div className="carousel-inner">
            ...
            <img src="11.jpg" className="d-block w-100" height="400" alt="..."/>
            ...
            <img src="12.jpg" className="d-block w-100" height="400" alt="..."/>
            <div className="carousel-caption d-none d-md-block">
            ...
            <div className="carousel-item">
            <img src="13.jpg" className="d-block w-100"  height="400" alt="..."/>
            <div className="carousel-caption d-none d-md-block">
